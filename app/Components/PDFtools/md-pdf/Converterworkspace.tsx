...
## Callouts, the GitHub/Obsidian way

> [!NOTE]
> Standard GitHub alert syntax renders as a styled, colored box — not a plain quote.

> [!WARNING] Heads up
> Callouts can have a custom title after the type, like this one.

> [!TIP]+
> Foldable callouts ([!tip]+ / [!tip]-) collapse on screen but always print expanded.
`;
...
export default function ConverterWorkspace() {
    ...
    const [stats, setStats] = useState({ wordCount: 0, readingTimeMin: 0, mermaidCount: 0, mathCount: 0, calloutCount: 0 });
            ...
            <div className="mx-auto max-w-6xl px-6 py-16">
                ...
                <div className="mt-6 rounded-xl border border-neutral-200 bg-white px-6 py-5">
                    <div className="flex flex-wrap items-end gap-5">
                        ...
                        <div className="ml-auto flex items-center gap-2">
                            <button
                                ...
                                title="Best quality: vector text, clean page breaks. Opens your browser's print dialog — choose 'Save as PDF'."
                    ...
                    <p className="mt-4 text-xs text-neutral-500 border-t border-neutral-100 pt-4">
                        ...
                        <span className="font-medium text-neutral-700">Save as PDF</span>. Produces
                        vector text, working hyperlinks, and clean page breaks around code blocks,
                        tables, and diagrams.
                    </p>

                    {(stats.mermaidCount > 0 || stats.mathCount > 0 || stats.calloutCount > 0) && (
                        <div className="mt-3 flex gap-4 font-mono text-xs text-neutral-500">
                            ...
                            {stats.calloutCount > 0 && <span>{stats.calloutCount} callout(s) rendered</span>}
                        </div>
                    )}
                </div>
            </div>
